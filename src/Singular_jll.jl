...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Singular_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("43d676ae-4934-50ba-8046-7a96366d613b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Singular", artifacts_toml) for e in artifacts["Singular"]]
...
if best_platform === nothing
    @debug("Unable to load Singular; unsupported platform $(triplet(platform_key_abi()))")
else
