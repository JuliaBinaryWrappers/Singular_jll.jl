...
JLLWrappers.@declare_library_product(libfactory, "@rpath/libfactory-4.4.0.dylib")
JLLWrappers.@declare_library_product(libomalloc, "@rpath/libomalloc-0.9.6.dylib")
JLLWrappers.@declare_library_product(libpolys, "@rpath/libpolys-4.4.0.dylib")
JLLWrappers.@declare_library_product(libsingular, "@rpath/libSingular-4.4.0.dylib")
JLLWrappers.@declare_library_product(libsingular_resources, "@rpath/libsingular_resources-4.4.0.dylib")
