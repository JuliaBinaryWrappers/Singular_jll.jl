...
JLLWrappers.@declare_library_product(libfactory, "libfactory-4.4.0.so")
JLLWrappers.@declare_library_product(libomalloc, "libomalloc-0.9.6.so")
JLLWrappers.@declare_library_product(libpolys, "libpolys-4.4.0.so")
JLLWrappers.@declare_library_product(libsingular, "libSingular-4.4.0.so")
JLLWrappers.@declare_library_product(libsingular_resources, "libsingular_resources-4.4.0.so")
