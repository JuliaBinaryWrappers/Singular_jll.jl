...
JLLWrappers.@declare_library_product(libfactory, "libfactory-4.1.3.so")
JLLWrappers.@declare_library_product(libomalloc, "libomalloc-0.9.6.so")
JLLWrappers.@declare_executable_product(libparse)
JLLWrappers.@declare_library_product(libpolys, "libpolys-4.1.3.so")
JLLWrappers.@declare_library_product(libsingular, "libSingular-4.1.3.so")
JLLWrappers.@declare_library_product(libsingular_resources, "libsingular_resources-4.1.3.so")
function __init__()
